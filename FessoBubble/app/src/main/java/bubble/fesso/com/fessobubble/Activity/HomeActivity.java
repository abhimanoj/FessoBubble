...
import bubble.fesso.com.fessobubble.fragment.GridViewFragment;
import bubble.fesso.com.fessobubble.fragment.HomeFragment;
import bubble.fesso.com.fessobubble.fragment.ListViewFragment;
...
//        setSupportActionBar(toolbar);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_quotes) {
            ...
            android.support.v4.app.FragmentTransaction fragmentTransaction =
                    getSupportFragmentManager().beginTransaction();
            fragmentTransaction.replace(R.id.fragment_container,sendQueryFragment);
            fragmentTransaction.commit();
